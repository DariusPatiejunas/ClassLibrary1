...
namespace ClassLibrary4
{
    class Class7
    {
        ...
        public static void TestSuma3()
        {
            ...
            IWebElement popUp = chrome.FindElement(By.Id("at-cv-lightbox-close"));
            popUp.Click();
            chrome.FindElement(By.Id("sum1")).Click();
            chrome.FindElement(By.Id("sum1")).SendKeys("a");
            chrome.FindElement(By.Id("sum2")).Click();
            chrome.FindElement(By.Id("sum2")).SendKeys("b");
